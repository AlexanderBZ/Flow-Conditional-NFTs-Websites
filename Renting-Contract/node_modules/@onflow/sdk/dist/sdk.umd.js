(function (global, factory) {
  ...
  spawn$1(HANDLERS$1, NAME$1);

  function put$2(key, value) {
    _send$1(NAME$1, PUT$1, {
      key: key,
      value: value
    });
    return config$1();
  ...
  function all$1() {
    return _send$1(NAME$1, GET_ALL$1, null, {
      expectReply: true,
      timeout: 10
    });
  }
  ...
  function subscribe$1(callback) {
    return subscriber$1(NAME$1, function () {
      return spawn$1(HANDLERS$1, NAME$1);
    }, callback);
  }

  function clearConfig$1() {
    return _send$1(NAME$1, CLEAR$1);
  }
  ...
  function voucherIntercept(fn) {
    return put$1("ix.voucher-intercept", fn);
  }
